...
function App() {
  ...
  const [gameAPI, setGameAPI] = useState({})
	...
	// 		const maxCells = 20 // set a maximum amount of cells wide
	...
	useEffect(() => {
		...
		setCellStyles({
			aspectRatio: "1 / 1",
			width: "100%",
			maxWidth: "700px",  // visually scales
	...
	return (
		<div>
			...
			<main className="w-full sm:w-xl md:w-2xl lg:w-4xl mx-auto flex flex-col md:flex-row items-center justify-center gap-4 lg:gap-6">
				<Sidebar
          mode={mode}
          isChecked={isChecked}
        ...
        />
				...
				<div ref={containerRef} className='game-container w-full md:w-8/12 mx-auto flex flex-row gap-2 items-center justify-center'>
					{gridSize && (
            mode === "manual" ? (
              <ManualSnakeGame
                gridSize={gridSize}
