...
export const STATIC_HAMILTONIAN_20x20: Position[] = [
...
export function generateStaticPath(): Position[] {
...
// export function generateHamiltonianCycle(size: number): Position[] {
